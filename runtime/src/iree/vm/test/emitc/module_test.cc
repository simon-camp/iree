...
#include "iree/vm/test/emitc/list_ops_f32.h"
#include "iree/vm/test/emitc/list_ops_f64.h"
...
std::vector<TestParams> GetModuleTestParams() {
  ...
  std::vector<ModuleDescription> modules = {
      ...
      {list_ops_f32_descriptor_, list_ops_f32_create},
      {list_ops_f64_descriptor_, list_ops_f64_create},
