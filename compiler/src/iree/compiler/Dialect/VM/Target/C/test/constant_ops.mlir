...
vm.module @rodata_ops {
  ...
  // CHECK-NEXT: [[BUFFER_PTR_VAR_1:[^ ]*]] = [[BUFFER_PTR_1]];
  // CHECK-NEXT: [[VOID_PTR_1:[^ ]*]] = (void*) [[BUFFER_PTR_VAR_1]];
  ...
  // CHECK-NEXT: [[BUFFER_PTR_VAR_2:[^ ]*]] = [[BUFFER_PTR_2]];
  // CHECK-NEXT: [[VOID_PTR_2:[^ ]*]] = (void*) [[BUFFER_PTR_VAR_2]];
